...
<p>**スクリプト**についての疑問：<ol class="numberlist numberlist-color4"><li>[Unityスクリプトリファレンスへようこそ](https://docs.unity3d.com/ja/current/ScriptReference/index.html)</u>にアクセスします。@css[detail-comment](「unity スクリプトリファレンス」で検索)</li><li><u>[C# リファレンス](https://docs.microsoft.com/ja-jp/dotnet/csharp/language-reference/)</u>にアクセスします。@css[detail-comment](「C# リファレンス」で検索)</li></ol></p>
