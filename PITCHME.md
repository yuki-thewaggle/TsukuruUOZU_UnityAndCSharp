...
* @css[text-white](バンタンゲームアカデミー高等部　講師)
* @css[text-white](合同会社ザワッグル　デザイナー・エンジニア)
* @css[text-white](アステリソフト合同会社　エンジニア)
